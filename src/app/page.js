...
export default function Home() {
  ...
  function openCarApp() {
    window.open(
      "https://play.google.com/store/apps/details?id=com.carmaintenancetracking.app"
    );
  }
  ...
  function openSocialCanvas() {
    window.open("https://apple.co/48bjGb1");
  }

  function openGeneralScienceBooks() {
    window.open(
      "https://play.google.com/store/apps/details?id=com.study.general.sciencebooks.app"
    );
  }
  ...
  return (
    <main class="bg-black">
      ...
      <header class="text-gray-600 body-font mx-8">
      ...
      <section class="text-gray-400 body-font mx-8">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/3 md:w-1/2 p-4">
              <div class="bg-gray-700 bg-opacity-40 p-6 rounded-3xl">
                <img
                  class="w-40 h-40 rounded-3xl object-cover object-center mb-6"
                  src="https://is1-ssl.mzstatic.com/image/thumb/Purple126/v4/b3/5f/43/b35f43b9-fbaa-4196-44cd-653228fb53d6/AppIcon-0-0-1x_U007epad-0-85-220.png/1200x1200bb.jpg"
                  alt="content"
                />
                ...
                <p class="leading-relaxed text-base">
                  Turn your words intovisually striking images. Start designing,
                  start sharing, & let your creativity shine!
                </p>
                <button
                  type="button"
                  id="swifthub-button"
                  onClick={() => openSocialCanvas()}
            ...
            <div class="xl:w-1/3 md:w-1/2 p-4">
              <div class="bg-gray-700 bg-opacity-40 p-6 rounded-3xl">
                ...
                <p class="leading-relaxed text-base">
                  Discover Car Maintenance Tracker, the ultimate car companion!
                  Track water, engine oil, tuning, tires, battery, and more.
                </p>
                <button
                  type="button"
                  id="car-button"
            ...
            <div class="xl:w-1/3 md:w-1/2 p-4">
              <div class="bg-gray-700 bg-opacity-40 p-6 rounded-3xl">
                <img
                  class="w-40 h-40 rounded-3xl object-cover object-center mb-6"
                  src="https://play-lh.googleusercontent.com/hel5dqfCsdB_btKDxxbD0w1v-ov55OJ9x85F6AS16EvSxOQKnVqmbTLAYUiV-py9Sw=w480-h960-rw"
                  alt="content"
                />
                <h3 class="tracking-widest text-blue-400 text-xs font-medium title-font">
                  Android
                ...
                <p class="leading-relaxed text-base">
                  Embark on an enlightening journey & effortlessly explore an
                  extensive collection of general science books.
                </p>
                <button
                  type="button"
                  id="pb-button"
                  onClick={() => openGeneralScienceBooks()}
                  class="bg-gray-700 mt-4 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-700 hover:bg-opacity-50 focus:outline-none"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <section class="text-gray-400 mx-4" ref={servicesSectionRef}>
        <div class="container px-5 py-12 mt-6 mx-auto">
          ...
          <div class="flex flex-wrap md:space-y-0 md:space-x-0 space-y-6">
            <div class="p-4 xl:w-1/3 md:w-1/2 flex flex-col text-left">
              <div class="bg-gray-700 bg-opacity-40 p-6 rounded-3xl">
                ...
                <div class="flex-grow">
                  <h2 class="text-white text-lg title-font font-medium mb-3 text-left">
                    Mobile App Development
                  </h2>
                  <p class="text-left text-sm">
                    We are at the forefront of mobile app development, offering
                    end-to-end solutions that empower your business in the
                    digital landscape. Our expert team leverages the latest
                    technologies and best practices to craft cutting-edge mobile
                    applications tailored to your unique needs. We cover native
                    iOS and Android app development, ensuring your apps are
                    optimized for specific platforms. Additionally, our
                    cross-platform expertise with frameworks like Flutter and
                    React Native enables us to deliver cost-effective and
                    efficient solutions, saving both time and resources.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="bg-gray-700 bg-opacity-40 p-6 rounded-3xl">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-left text-sm">
                    ...
                    projects, ensure efficiency, and achieve desired outcomes.
                    Our experienced project managers meticulously plan, execute,
                    and oversee projects of various sizes and complexities. We
                    employ industry-standard methodologies, such as Agile or
                    Waterfall, to meet your specific needs. Our services include
                    defining project scope, setting milestones, assigning tasks,
                    monitoring progress, and mitigating risks. We excel in
                    stakeholder communication and team collaboration, ensuring
            ...
            <div class="p-4 xl:w-1/3 md:w-1/2 flex flex-col text-left">
              <div class="bg-gray-700 bg-opacity-40 p-6 rounded-3xl">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-left text-sm">
                    We take quality assurance seriously. Our dedicated team of
                    QA professionals is committed to ensuring that your products
                    or services meet the highest standards of excellence. With a
                    keen eye for detail and a rigorous testing process, we
                    identify and rectify issues before they impact your
                    customers. Our comprehensive QA services encompass
                    functionality testing, performance testing, security
                    testing, and usability testing, among others. We work
                    closely with your team to understand your specific
                    requirements, enabling us to tailor our QA approach to your
                    unique needs.
                  </p>
                </div>
              </div>
              ...
              <div class="bg-gray-700 bg-opacity-40 p-6 rounded-3xl">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-left text-sm">
                    ...
                    to propel your business to new heights. Our dedicated team
                    of experts leverages the latest digital tools and strategies
                    to create tailored solutions that drive results. From SEO to
                    PPC advertising, social media management, content marketing,
                    and email campaigns, we've got you covered. We take the time
                    to understand your unique goals and audience, allowing us to
            ...
            <div class="p-4 xl:w-1/3 md:w-1/2 flex flex-col text-left">
              <div class="bg-gray-700 bg-opacity-40 p-6 rounded-3xl">
                ...
                <div class="flex-grow">
                  ...
                  <p class="text-left text-sm">
                    We're your trusted partner for website development,
                    dedicated to crafting exceptional online experiences that
                    elevate your digital presence. Our team of skilled
                    developers excels in the latest web technologies, ensuring
                    your website stands out in today's competitive digital
                    landscape. We specialize in developing dynamic, responsive,
                    and user-friendly websites using cutting-edge technologies
                    such as ReactJS and NextJS. Our design and development
                    process focuses on delivering not only visually appealing
                    websites but also highly functional ones that engage your
      ...
      <section class="text-gray-400 body-font mx-8" ref={clientSectionRef}>
          ...
          <div class="flex flex-wrap -mx-4 -mb-10 text-center mx-auto">
            ...
            <div class="md:w-1/2 sm:w-1/1 mb-10 px-4 mx-auto flex flex-row justify-center items-center">
              <div class="font-bold w-60 h-60 text-center bg-gray-700 bg-opacity-40 p-6 rounded-3xl text-5xl text-white">
                <h1 class="mx-auto flex flex-row justify-center h-44 items-center">
                  Seizure Detector
                </h1>
              </div>
            </div>
      ...
      <footer class="text-gray-400 body-font mx-8">
